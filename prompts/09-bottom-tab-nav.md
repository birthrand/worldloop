...
Implement only the bottom tab navigation based on the attached design. Create the tab routes for Home, Learn, Practice, Progress, and Profile with simple placeholder screens for now.
