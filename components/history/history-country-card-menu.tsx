...
type HistoryCountryCardMenuProps = {
  country: Country;
...
export function HistoryCountryCardMenu({
  country,
  style,
}: HistoryCountryCardMenuProps) {
  ...
  const handleRemove = () => {
    closeMenu();
    removeEntry(historyEntryKey({ kind: "country", country, viewedAt: 0 }));
  };
