...
type SavedLayoutToggleProps = {
  layout: SavedCountriesLayout;
  onLayoutChange: (layout: SavedCountriesLayout) => void;
};

function SavedLayoutToggle({ layout, onLayoutChange }: SavedLayoutToggleProps) {
  return (
  ...
  return (
    <View style={styles.row}>
      ...
      <View style={[styles.sideSlot, styles.sideSlotEnd]}>
        {onLayoutChange ? (
          <SavedLayoutToggle layout={layout} onLayoutChange={onLayoutChange} />
        ) : null}
      </View>
    </View>
  );
