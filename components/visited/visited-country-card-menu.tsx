...
type VisitedCountryCardMenuProps = {
  country: Country;
...
export function VisitedCountryCardMenu({
  country,
  style,
}: VisitedCountryCardMenuProps) {
  const insets = useSafeAreaInsets();
  const [open, setOpen] = useState(false);
  const toggleCountryVisited = useDiscoveryProgressStore(
    ...
    <>
      ...
      >
        ...
        <View style={styles.menuPanel}>
          <MenuRow
            label="Remove"
            subtitle="Remove from your visited list"
            destructive
